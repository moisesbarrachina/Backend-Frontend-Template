...
/**
 * Explaining the visibility needed on the functions
 *
...
<div class="wrap bft_wrap bft_wrap_ol_ul">
	...
	<p><?=$this->esc_html_e("A quick summary for what visibility to use on the functions of your plugin")?>:</p>
	<ul>
			<li>
				<h3>Private</h3>
			...
			<li>
				<h3>Protected</h3>
				<p><?=$this->esc_html_e("Ideal for the internal functions for security reasons, only your classes can use this functions")?></p>
			</li>
			<li>
				<h3>Public</h3>
				<p><?=$this->esc_html_e("Some functions need to be public due to how WordPress works")?>:
				</p>
				<ul>
					...
					<li><?=$this->esc_html_e("Functions called via install, upgrade or unistall")?></li>
